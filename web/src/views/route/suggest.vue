<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>景点建议信息</el-breadcrumb-item>
    </el-breadcrumb>


    <!-- 搜索筛选 -->
    <el-form :inline="true" :model="formInline" class="user-search">
      <el-form-item label="建议人姓名">
        <el-select v-model="formInline.uid" placeholder="请选择建议人姓名" clearable >
          <el-option v-for="item in userList" :label="item.name" :value="item.id" :key="item.id"/>
        </el-select>
      </el-form-item>

      <el-form-item label="建议景点">
        <el-select v-model="formInline.rid" placeholder="请选择建议景点" clearable >
    ...
    <el-table size="small" :data="userData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column align="center"  prop="name" label="建议人姓名" >
      </el-table-column>
      <el-table-column align="center"  prop="rname" label="建议景点" >
      </el-table-column>
      <el-table-column align="center"  prop="content" label="建议内容" >
      </el-table-column>
      <el-table-column align="center"  prop="created" label="建议时间" >
      </el-table-column>
