  ...
  <div>
    ...
    <el-form :inline="true" :model="formInline" class="user-search">
      <el-form-item label="管理员账号">
        <el-input clearable size="small" v-model="formInline.account" placeholder="请输入管理员账号"></el-input>
      </el-form-item>
      <el-form-item label="账号状态">
        <el-select v-model="formInline.status" placeholder="请选择账号状态">
    ...
    <el-table size="small" :data="userData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column align="center" sortable prop="account" label="管理员账号" min-width="120">
      </el-table-column>
    ...
    @click='closeDialog("edit")'>
      <el-form label-width="120px" ref="editForm" :model="editForm" :rules="rules">
        <el-form-item label="管理员账号" prop="account">
          <el-input :disabled="updateKey" size="small" v-model="editForm.account" auto-complete="off" placeholder="请输入管理员账号"></el-input>
        </el-form-item>
...
<script>
// 导入请求方法
import {adminList,adminSave,adminDelete, adminUpdate} from '../../api/admin'
      ...
      this.$refs[editData].validate(valid => {
        if (valid) {
          if(this.editForm.id){
            ...
            adminSave(this.editForm).then(res=>{
              this.$message({
                type: 'success',
                message: '添加成功!'
              })
